...
class HARAPP(object):
    ...
    def load_dataset(self, prefix=''):
        # load all train
        trainX, trainy = self.load_dataset_group('train', prefix + '/home/pi/workspace/working_with_neural_networks/HARDataset/')
        print(trainX.shape, trainy.shape)
        # load all test
        testX, testy = self.load_dataset_group('test', prefix + '/home/pi/workspace/working_with_neural_networks/HARDataset/')
    ...
    def get_real_time_data(self):
        prefix = '/home/pi/workspace/working_with_neural_networks/RealTimeData/'
        filepath = prefix
        # load all 9 files as a single array
        filenames = list()
        # total acceleration
